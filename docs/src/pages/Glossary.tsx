    ...
    ja: {
      ...
      terms: [
        ...
        },
        {
          id: 'bijection',
          term: '全単射 (Bijection)',
          body: 'チェーンの形、出力される CSS ルール、class 名のハッシュの三つが、一対一に対応する。同じ形のチェーンはコードベースのどこに書いても同じハッシュを生む。変数名を変えても、ファイルを移してもハッシュは変わらない。DevTools に表示される class から、ソース上のチェーンへ一意に辿り直せる。',
        },
        {
          id: 'canonical',
